...
window.PS = (function () {
  ...
  function renderTopbar(config) {
    ...
    if (waUrl) {
      social.push(`<a href="${waUrl}" target="_blank" rel="noopener" aria-label="WhatsApp" class="opacity-80 hover:opacity-100"><svg viewBox="0 0 24 24" class="h-4 w-4" fill="currentColor"><path d="M17.6 6.32A7.85 7.85 0 0 0 12.05 4a7.94 7.94 0 0 0-7.94 7.94c0 1.4.37 2.76 1.07 3.96L4 20l4.2-1.1a7.9 7.9 0 0 0 3.85 1h.003a7.94 7.94 0 0 0 7.94-7.94 7.9 7.9 0 0 0-2.34-5.64ZM12.05 18.4a6.4 6.4 0 0 1-3.27-.9l-.23-.14-2.44.64.65-2.38-.15-.24a6.4 6.4 0 0 1-1-3.44 6.46 6.46 0 0 1 11.02-4.58 6.4 6.4 0 0 1 1.9 4.58 6.46 6.46 0 0 1-6.46 6.46Zm3.54-4.84c-.19-.1-1.15-.57-1.33-.63-.18-.06-.3-.1-.44.1-.13.2-.5.63-.6.75-.12.13-.23.15-.42.05-.19-.1-.82-.3-1.56-.96a5.8 5.8 0 0 1-1.08-1.34c-.11-.19 0-.3.09-.4.09-.09.19-.23.29-.34.1-.12.13-.2.2-.33.06-.13.03-.25 0-.35-.05-.1-.44-1.06-.6-1.45-.16-.38-.32-.33-.44-.33h-.37c-.13 0-.34.05-.52.25-.18.2-.68.67-.68 1.63 0 .96.7 1.9.8 2.02.1.13 1.37 2.1 3.33 2.94.47.2.83.32 1.12.4.47.15.9.13 1.24.08.38-.06 1.15-.47 1.31-.92.16-.46.16-.85.11-.93-.05-.08-.18-.13-.37-.23Z"/></svg></a>`);
    }
    el.innerHTML = `
